...
\begin{document}
    ...
    \begin{bemerkung}
        ...
        \begin{align*}
            ...
            \intertext{Allerdings gilt}
            \frac{f\of{x+\alpha ix} - f\of{0}}{x + \alpha ix} &= \ldots = \frac{\alpha}{1+\alpha^2}
        \end{align*}
    \end{bemerkung}

    \begin{satz}[Ableitung von Kompositionen komplexe Funktionen]
    ...
    \begin{bemerkung}[Alternative Herleitung von Cauchy-Riemann]
        ...
        \begin{align*}
            f\of{x+h_1, g+h_2} &= f\of{x,y} + Ah + \underbrace{\varepsilon\of{h}}_{\to 0\text{ für } h\to 0}\cdot h\tag{$h\coloneqq\begin{pmatrix}
                                                                                                                                       h_1 \\
                                                                                                                                       h_2
            \end{pmatrix}$}
            \intertext{Wir spalten $f$ zwei Funktionen auf. Das heißt es sei}
            f &= \begin{pmatrix}
                     u \\
                     v
            \end{pmatrix}
